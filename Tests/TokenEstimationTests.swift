...
class TokenEstimationTests: XCTestCase {
    ...
    func testEnglishTextEstimation() {
        ...
        assertTokenCount(estimated, expected: 20, accuracy: 2, "English text estimation should be within ±2 tokens")
    }
    ...
    func testCJKTextEstimation() {
        ...
        assertTokenCount(estimated, expected: 18, accuracy: 3, "CJK text estimation should be within ±3 tokens")
    }
    ...
    func testMixedLanguageEstimation() {
        ...
        // Expected: ~18 tokens
        assertTokenCount(estimated, expected: 18, accuracy: 3, "Mixed language estimation should be within ±3 tokens")
    }
    ...
    func testSwiftCodeEstimation() {
        ...
        assertTokenCount(estimated, expected: 27, accuracy: 4, "Swift code estimation should be within ±4 tokens")
    }
    ...
    func testJSONEstimation() {
        ...
        assertTokenCount(estimated, expected: 31, accuracy: 5, "JSON estimation should be within ±5 tokens")
    }
    ...
    func testDetectCodeContent() {
        let code = "func test() { let x = 10; var y = 20; class Foo { func bar() { import Foundation } } return x + y }"
    ...
    private func assertTokenCount(_ actual: Int, expected: Int, accuracy: Int, _ message: String) {
